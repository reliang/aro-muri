		...
		if($_POST['chatbody'] == ""){
			...
			<br><p>To read the latest message(s), please go to: <a style='text-decoration:none' href='https://aro-muri2020.seas.upenn.edu/cgi-bin/internal-discussion'>[ARO-MURI Site]</a>
